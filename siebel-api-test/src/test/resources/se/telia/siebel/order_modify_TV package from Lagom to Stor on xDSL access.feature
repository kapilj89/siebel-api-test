Feature: Modify
  ...
  This scenario is a bit tricky because some steps will not be executed under all circumstances
    Given call QueryAsset using SSN "196712183018" to get asset details AssetNumber and ServiceAccountId for promotionName "P-TV-IPTV-PlayPlus-1711"
    And call ModifyAssetToQuote for the RelationshipName "OptGrp-TV-TeliaPackages-1704" and Package "TV-Lagom-1606" to "TV-Stor-1606"
    And call BeginConfigurationService using product item name "Service Bundle-TV-IPTV-1704"
   	And call ModifyProduct to set RelationShipName "OptGrp-TV-TeliaPackages-1704" and Package "TV-Lagom-1606" to "TV-Stor-1606"
