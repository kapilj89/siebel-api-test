...
@CucumberOptions(features = { "src/test/resources/se/telia/SanityPackage/Mobile" }, tags = {
		"@SanityMobileSupplementoryData,@SanityMobileSupplementoryVoice,@SanityMobileBaseMobileVoice,@SanityMobileBaseMBB" }, plugin = {
				"pretty", "json:target/cucumber_report/siebel-api-test-cucumber_report.json" }

)
public class RunCukesTest_SanityMobileBase {
}
